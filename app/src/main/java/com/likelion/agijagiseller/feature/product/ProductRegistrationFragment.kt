 ...
 * Use the [ProductRegistrationFragment.newInstance] factory method to
...
class ProductRegistrationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProductRegistrationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProductRegistrationFragment().apply {
